...
public class AttendantDashboardController {
  ...
  @FXML
  private void goToQueue(ActionEvent e) {
    nav(e, "/fxml/attendant/AttendantQueue.fxml");
  }

  @FXML
  private void goToSampleTracking(ActionEvent e) {
    nav(e, "/fxml/attendant/SampleTracking.fxml");
  }

  @FXML
  private void goToResultUpload(ActionEvent e) {
    nav(e, "/fxml/attendant/ResultUpload.fxml");
  }
  ...
  private void goToUserManagement(ActionEvent e) {
    nav(e, "/fxml/attendant/AttendantUserManagement.fxml");
  }
